      ...
      <div className="min-h-screen bg-background flex flex-col md:flex-row">
        ...
        >
          ...
          <div className="z-10 text-center p-8 glass-light dark:glass-dark rounded-2xl max-w-md mx-auto">
            <img src="/images/logo.png" alt="Euro Visa" className="h-16 mx-auto mb-4" />
            <h2 className="text-3xl font-bold mb-4">Euro Visa</h2>
        ...
        >
          <div className="w-full max-w-md">
            <div className="glass-light dark:glass-dark rounded-2xl p-8 shadow-lg">
