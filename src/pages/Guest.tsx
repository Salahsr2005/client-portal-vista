  ...
  const guestFeatures = [
    {
      ...
      description: "Explore study abroad destinations and universities worldwide",
    ...
    },
    {
      icon: <Eye className="h-6 w-6" />,
      title: "View Programs",
      description: "Discover academic programs and courses available",
      path: "/guest/programs",
    ...
    },
    {
      ...
      description: "Learn about our comprehensive support services",
      path: "/guest/services",
    ...
    },
    {
      ...
      description: "Experience our consultation process and get guidance",
    ...
    },
    {
      ...
      description:
        "Access our premium medication network and connect with verified providers for essential medications",
      path: "/guest/dawini",
      ...
      <div className="relative z-10 py-8 sm:py-12 lg:py-16">
        <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              Discover our platform's features and services without creating an account. Get a preview of what Vista has
              to offer.
            </motion.p>
