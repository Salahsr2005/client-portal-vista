...
import { Calendar, Clock, DollarSign, FileText, Loader, Map, Settings, Shield, Users } from "lucide-react";
  ...
  const fallbackFeatures = [
    {
      ...
      description: "Personalized guidance from our experienced visa and education consultants.",
    ...
    },
    {
      ...
      description: "End-to-end support throughout the entire application process.",
      ...
      <div className="container max-w-7xl mx-auto px-4">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            {t("features.title", "Our Services & Features")}
          </h2>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            {t("features.subtitle", "Comprehensive solutions to help you navigate your international education and immigration journey.")}
          </p>
        </motion.div>
