  ...
  const testimonials =
    destinations.length > 0
      ? destinations.map((destination, index) => ({
          ...
          image: destination.image || `/placeholder.svg?height=100&width=100`,
          rating: 4 + (index % 2),
                ...
                <Card className="h-full border border-primary/10 hover:shadow-md transition-all duration-300">
                  ...
                  <CardContent>
                    <div className="relative">
                      ...
                      <p className="pt-4 relative z-10 text-muted-foreground">{testimonial.text}</p>
                      <div className="mt-4 text-sm font-medium text-primary">{testimonial.position}</div>
                    </div>
                  </CardContent>
                </Card>
              </motion.div>
