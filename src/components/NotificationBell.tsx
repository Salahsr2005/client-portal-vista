...
import { Bell, Check, MessageSquare, FileText, Calendar, CreditCard, Package } from 'lucide-react';
              ...
              {isLoading ? (
                ...
                <div>
                  {notifications.map((notification) => (
                    <div
                      key={notification.id}
                      className={`p-3 hover:bg-muted cursor-pointer ${!notification.is_read ? 'bg-muted/40' : ''}`}
